...
// that import executes the migration runner, which is how CI went red
// on the merge to main. The mechanism lives in
// scripts/lib/entry-point.ts, and scripts/entry-points.test.ts fails
// any script under scripts/ that forgets it.
