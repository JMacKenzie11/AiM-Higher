...
- **Change a Priority's status** — on the Priority detail page,
  the status picker flips a Priority to on-track / at-risk /
  complete / done.
- **Start a new planning cycle** (system admins only) via
  *Companies → this company → Planning cycle*. Details below.
:::
...
**Why can't I add a Priority?** A Priority needs an open quarter.
If none is open, you'll see an empty state and a link to
