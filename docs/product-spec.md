...
Practices are prompt-narrowed variants of the Ask Aimee coach — a stable card on the *Practice Coaches* tab of `/ask-aimee` (Section 14), a shared chat surface, and (per practice) an optional structured output card the assistant can emit.
