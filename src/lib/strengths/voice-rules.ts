...
- "not a small thing," "no small feat," "not nothing," "not an accident," "not insignificant," "not uncommon" and every other affirmation-by-denial. Say what the thing IS: "that's significant," "that took real discipline," "most teams can't do that." Denying the opposite makes a compliment sound grudging and leaves the reader working out what you meant.
- em-dashes
